...
import software.hellscaped.archimedes.GuiButtonArchimedes;
...
public class GuiMainMenu extends GuiScreen {
	...
	public GuiMainMenu() {
		...
		this.field_92025_p = "Archimedes Client";
	...
	public void initGui() {
		...
		if(EaglerAdapter.isIntegratedServerAvailable()) {
			this.buttonList.add(new GuiButtonArchimedes(1, this.width / 2 - 100, var4, var2.translateKey("menu.singleplayer")));
			this.buttonList.add(new GuiButtonArchimedes(2, this.width / 2 - 100, var4 + 24 * 1, var2.translateKey("menu.multiplayer")));
			this.buttonList.add(new GuiButtonArchimedes(3, this.width / 2 - 100, var4 + 24 * 2, var2.translateKey("menu.forkme")));
		}else {
			this.buttonList.add(new GuiButtonArchimedes(2, this.width / 2 - 100, var4, var2.translateKey("menu.multiplayer")));
			this.buttonList.add(new GuiButtonArchimedes(3, this.width / 2 - 100, var4 + 24, var2.translateKey("menu.forkme")));
		}

		this.buttonList.add(new GuiButtonArchimedes(0, this.width / 2 - 100, var4 + 72 + 12, 98, 20, var2.translateKey("menu.options")));
		this.buttonList.add(new GuiButtonArchimedes(4, this.width / 2 + 2, var4 + 72 + 12, 98, 20, var2.translateKey("menu.editprofile")));
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		*/
		...
		EaglerAdapter.glPushMatrix();
		EaglerAdapter.glTranslatef((this.width - 2), 1.0f, 0.0f);
