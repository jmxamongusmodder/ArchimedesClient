...
public class ConfigConstants {
	...
	public static final String mainMenuString = "Archimedes Client " + version;
	
	public static final String forkMe = "https://github.com/ArchimedesClient/ArchimedesClient";
